...
// const usersCardContainer = document.querySelector("#usersContainer");
...
// //     const usernameEle = document.createElement("h1");
// //     const cityEle = document.createElement("h2");
// //     const userIdEle = document.createElement("p");

// //     usernameEle.textContent = `USERNAME : ${username}`;
// //     cityEle.textContent = `CITY : ${city}`;
// //     userIdEle.textContent = `USERID : ${id}`;

// //     cardContainer.append(userIdEle, usernameEle, cityEle);

// //     usersCardContainer.append(cardContainer);
// //   });
// // }
...
//     cardContainer.innerHTML = `<h1>USERNAME : ${username}</h1>
//     <h2>CITY : ${city}</h2>
//     <p>USERID : ${id}</p>
//     `;
...
//   try {
//     let resp = await fetch("https://dummyjson.com/users"); // 10s
//     let data = await resp.json(); // parse JSON data to JS Object
...
//     const fullNameELe = document.createElement("h1");
//     fullNameELe.textContent = `${firstName} ${lastName}`;
//     usersContainer.append(fullNameELe);
//   });
// }

//! EVENTS :  ACTION PERFORMED BY USER
// events can be applied in 2 ways
// 1) using event attribute : onclick , ondblclick , onmouseenter , onmousemove , onmouseleave , onscroll , onload , onsubmit ...
...
// 2) using addEventListener("event" , callback , useCapture) : RECOMMENDED
